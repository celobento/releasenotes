...
class PerfisControllerTest < ActionController::TestCase
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post :create, perfil: { descrcicao: @perfil.descrcicao, nome: @perfil.nome, role: @perfil.role, status: @perfil.status }
    end
  ...
  test "should update perfil" do
    patch :update, id: @perfil, perfil: { descrcicao: @perfil.descrcicao, nome: @perfil.nome, role: @perfil.role, status: @perfil.status }
    assert_redirected_to perfil_path(assigns(:perfil))
  end
